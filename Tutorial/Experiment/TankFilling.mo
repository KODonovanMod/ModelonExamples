...
model TankFilling
    extends .Tutorial.Experiment.TankTestBase(storageTank(rel_level_start = 0.01,geo(y(start = r_inner)),enable_liquidHeatPort = false,tankInitQuantity = Modelon.ThermoFluid.Choices.TwoPhaseTankInitTypes.initFromLevel),checkValve(dp_open = p_max - 101305));
